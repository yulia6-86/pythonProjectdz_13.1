...
def test_init_category(category_tv):
    ...
    assert category_tv.products == [Product ("Sony", "Описание Sony", 25000, 18), Product ("Samsung", "Описание Samsung", 35000, 8)]
    assert category_tv.categories_count ==1
    assert category_tv.count_products ==2
